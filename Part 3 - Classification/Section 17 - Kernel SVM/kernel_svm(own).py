...
classifier=SVC(kernel="rbf",random_state=0) #here kernel may be gaussian,poly or linear
                           #classifier's shape will vary according to that...
                           #rbf is for gaussian
...
cm = confusion_matrix(y_test, y_pred)   #THIS MATRIX WILL TELL US HOW MANY CORRECT AND INCORRECT
                     #PREDICTIONS DID WE MAKE. 
                     #AND 4+3 INCORRECT PREDICTIONS..
