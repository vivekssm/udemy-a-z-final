...
classifier=KNeighborsClassifier(n_neighbors=5,metric="minkowski",p=2) #here neighbours are 5
                                                             #p=2 means euklidian distance
                                                             #google the modelname to know this
...
cm = confusion_matrix(y_test, y_pred)   #THIS MATRIX WILL TELL US HOW MANY CORRECT AND INCORRECT
                 ...
                 #visualizing cm matrix will give 4+3=7 incorrect predictions


#CODE FOR GRAPH COPIED FROM LOGISTIC REGRESSION 
