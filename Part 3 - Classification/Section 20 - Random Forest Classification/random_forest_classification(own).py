...
classifier=RandomForestClassifier(n_estimators=10,criterion="entropy",random_state=0) #here,no of trees=10 
...
cm = confusion_matrix(y_test, y_pred)   #THIS MATRIX WILL TELL US HOW MANY CORRECT AND INCORRECT
                     #PREDICTIONS DID WE MAKE.  HERE WE have
                     #5+3 INCORRECT PREDICTIONS..
